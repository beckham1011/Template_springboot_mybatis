                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" id="userForm">
	                        ...
	                        <div class="form-group">
	                            ...
	                            <div class="col-sm-8">
	                            	<input id="measuringPoint" name="measuringPoint" class="form-control" type="text" value="" />
	                            </div>
	                        </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">故障类型：<label style="color:red">*</label></label>
                                <div class="col-sm-8">
                                    <input id="failure" name="failure" class="form-control" type="text" value="" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
	                            ...
	                            <div class="col-sm-8">
                                    <input id="reportingTime" name="reportingTime" class="form-control" type="text" value="" />
                                </div>
	                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="reportingPer" name="reportingPer" class="form-control" type="text" value="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">申报人电话：<label style="color:red">*</label></label>
                                <div class="col-sm-8">
                                    <input id="reportingPhone" name="reportingPhone" class="form-control" type="text" value="">
                                </div>
                            </div>
                            <div class="form-group">
	                            <label class="col-sm-3 control-label">受理时间：<label style="color:red">*</label></label>
	                            <div class="col-sm-8">
	                                <input id="acceptTime" name="acceptTime" class="form-control" type="text" value="">
	                            </div>
	                        </div>
	                        <div class="form-group">
	                            <label class="col-sm-3 control-label">受理人：<label style="color:red">*</label></label>
	                            <div class="col-sm-8">
	                        		<input id="acceptPer" name="acceptPer" class="form-control" type="text" value="">
	                            </div>
	                        </div>
	                        <div class="form-group">
	                            <label class="col-sm-3 control-label">受理人电话：<label style="color:red">*</label></label>
	                            <div class="col-sm-8">
	                        		<input id="acceptPhone" name="acceptPhone" class="form-control" type="text" value="">
	                            </div>
	                        </div>
	                        <div class="form-group">
	                            <label class="col-sm-3 control-label">维修结果：<label style="color:red">*</label></label>
	                            <div class="col-sm-8">
	                        		<input id="results" name="results" class="form-control" type="text" value="">
	                            </div>
	                        </div>
	    ...
	    $("#userForm").validate({
    	    ...
    	    submitHandler:function(form){
    	    	$.ajax({
   	    		   type: "POST",
   	    		   dataType: "json",
   	    		   url: "${ctx}/declarationrecord/save",
   	    		   data: $(form).serialize(),
