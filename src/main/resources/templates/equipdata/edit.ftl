                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" id="userForm">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="name" name="name" class="form-control" type="text" value="${data.name}"  disabled="disabled" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="addressCode" name="addressCode" class="form-control" type="text" disabled="disabled" value="${data.addresscode}" />
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-sm-3 control-label">正累计：</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="flowrate" name="flowrate" class="form-control" type="text" value="${data.flowrate?c}">
                                </div>
                            </div>
