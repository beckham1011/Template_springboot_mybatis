                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" id="userForm">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="unitName" name="unitName" class="form-control" type="text" value="${datacard.unitName}" />
                                </div>
                            </div>
	                        <div class="form-group">
	                            ...
	                            <div class="col-sm-8">
	                                <select name="costStandard" id="costStandard" class="form-control"  style="width:160px;float:left;height:auto;">
	                                	<#list costStandards as item>
		                                	<#if datacard.costStandard == item.id>
		                            			<option value="${item.id}" selected >${item.costStandard}</option>
		                            		</#if>
		                            		<#if datacard.costStandard != item.id>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="equipName" name="equipName" class="form-control" type="text" value="${datacard.equipName}" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
	                            ...
	                            <div class="col-sm-8">
                                    <input id="mobilePhone" name="mobilePhone" class="form-control" type="text" value="${datacard.mobilePhone}" />
                                </div>
	                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="amount" name="amount" class="form-control" type="text" value="${datacard.amount}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">充值时间：<label style="color:red">*</label></label>
                                <div class="col-sm-8">
                                    <input id="refillTime" name="refillTime" class="form-control" type="text" value="${datacard.refillTime}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">当前余额：<label style="color:red">*</label></label>
                                <div class="col-sm-8">
                                    <input id="balance" name="balance" class="form-control" type="text" value="${datacard.balance}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">当前状态：<label style="color:red">*</label></label>
                                 <div class="col-sm-8">
	                                ...
	                                <#if datacard.currentState == '1'>
	                            		<option value="1" selected>正常</option>
	                            		<option value="2" >欠费</option>
	                            	</#if>
	                            	<#if datacard.currentState == '2'>
