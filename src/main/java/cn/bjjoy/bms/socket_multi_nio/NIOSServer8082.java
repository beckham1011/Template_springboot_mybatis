...
public class NIOSServer8082 extends AbstractSocketServer{
    ...
    public String[] parseCustomerEquipData(String receiveText) {
    	return  SpringSocketUtil.parse8082SocketData(receiveText);
    }
